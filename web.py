...
with st.container():
    ...
    # First Project
    col1, col2 = st.columns([1, 2])  # 1:2 ratio for image:text

    with col1:
        st.image("images/project christmas.jpg", use_column_width=True)
    ...
    st.write("###")  # space between projects

    # Second Project
    col3, col4 = st.columns([1, 2])  # again, 1:2 layout

    with col3:
        st.image("images/project prog.png", use_column_width=True)
